...
const renderEditDeleteButton = (comment: GaleriaComment = mockComment) => {
  return render(
    <EditDeleteButton
      onEdit={mockOnEdit}
...
describe('EditDeleteButton', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should have proper button styling', () => {
      const { container } = renderEditDeleteButton();
  ...
  describe('Different Comments', () => {
    it('should pass correct comment id to onEdit', () => {
      ...
      renderEditDeleteButton(differentComment);
    ...
    it('should handle comment with special characters', () => {
      ...
      renderEditDeleteButton(specialComment);
  ...
  describe('Props Variation', () => {
    it('should render with different comment data', () => {
      ...
      const { rerender } = renderEditDeleteButton(comment1);
